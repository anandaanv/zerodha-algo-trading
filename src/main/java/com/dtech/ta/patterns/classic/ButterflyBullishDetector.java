...
/**
 * Detector for Bullish Butterfly harmonic pattern.
 ...
 * Reference: docs/spec-classic-patterns-port.md (Butterfly Bullish section)
 */
public class ButterflyBullishDetector implements ClassicPatternDetector<ButterflyPattern> {
    ...
    /**
     * Search for bullish Butterfly patterns using the X := lowest-pivot-in-series loop.
     */
    private List<ButterflyPattern> searchBullish(BarSeries series, List<PivotPoint> pivots,
    ...
    /**
     * Check if Butterfly is well-formed: highest_xb == a, lowest_ac == b, highest_from_b == c.
