...
/**
 * Detector for Bearish Crab harmonic pattern.
 ...
 * Reference: docs/spec-classic-patterns-port.md (Crab Bearish section)
 */
public class CrabBearishDetector implements ClassicPatternDetector<CrabPattern> {
    ...
    /**
     * Search for bearish Crab patterns using the X := highest-pivot-in-series loop.
     */
    private List<CrabPattern> searchBearish(BarSeries series, List<PivotPoint> pivots,
    ...
    /**
     * Check if Crab is well-formed: lowest_xb == a, highest_ac == b, lowest_from_b == c.
