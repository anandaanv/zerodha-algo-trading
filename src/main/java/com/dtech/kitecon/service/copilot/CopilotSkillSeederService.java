...
/**
 * Seeds demo, chart-pattern, wave, and reasoning skills for new users.
 * Contains all skill template builders (~36 skill definitions).
 */
@Service
@RequiredArgsConstructor
public class CopilotSkillSeederService {
