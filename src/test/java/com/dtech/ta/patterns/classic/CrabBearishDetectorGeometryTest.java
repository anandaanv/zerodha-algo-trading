...
class CrabBearishDetectorGeometryTest {
    ...
    void testBearishCrabDetection(String description, String expectedKind) {
    ...
    void testBearishCrabNoPattern(String description, int minPivots, int lookback) {
