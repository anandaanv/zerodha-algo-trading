...
/**
 * Unit tests for bearish Gartley detector geometry.
 * Tests pattern detection with synthetic data (5 pivots, b=0.618, c in [0.382, 0.886]).
 */
class GartleyBearishDetectorGeometryTest {

    @ParameterizedTest(name = "{index}: {0}")
    @CsvSource({
        "Clean bearish Gartley with b=0.618 c=0.618,PERFECT",
    ...
    void testBearishGartleyDetection(String description, String expectedKind) {
    ...
    void testBearishGartleyNoPattern(String description, int minPivots, int lookback) {
