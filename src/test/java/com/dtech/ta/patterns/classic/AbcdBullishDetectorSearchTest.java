...
/**
 * Integration tests for bullish ABCD detector search algorithm.
 */
class AbcdBullishDetectorSearchTest {

    @Test
    void testCleanBullishAbcdFind() {
    ...
    @Test
    void testNoBullishAbcdWithInsufficientPivots() {
