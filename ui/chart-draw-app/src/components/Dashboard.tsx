  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Simulation Viewer Card - USER */}
        {hasRole("USER") && (
          <div
            onClick={() => navigate("/simulation-viewer")}
            style={{
              background: "#fff",
              borderRadius: "16px",
              padding: "2.5rem",
          ...
          >
            ...
            <p style={{ color: "#666", fontSize: "0.95rem" }}>
              Visualize chart-pattern simulation trades with detailed analysis
            </p>
          </div>
        )}

        {/* AI Trader Card - ADMIN */}
        {hasRole("ADMIN") && (
          <div
          ...
          >
            ...
            <p style={{ color: "#666", fontSize: "0.95rem" }}>
              Bulk AI levels analysis with watch-trades for FNO symbols
            </p>
          </div>
        )}
      </div>
